...
trait AzureCosmosTestProperties implements TestPropertyProvider {
    ...
    Map<String, String> getProperties() {
        ...
        ).withEnv(PARTITION_COUNT_PROP, PARTITION_COUNT_VAL).waitingFor(Wait.forHttps("/_explorer/emulator.pem").forStatusCode(200).allowInsecure().withStartupTimeout(STARTUP_TIMEOUT))
        emulator.start()
